...
import { getPointFromEvent, snapToGridPoint, type Point } from "../utils/canvasUtils";
...
export default function Canvas({
	...
	const snapToGridPointFn = useCallback(
		(point: Point) => snapToGridPoint(point, snapToGrid, gridCellWidth, gridCellHeight),
		[snapToGrid, gridCellWidth, gridCellHeight],
	);

	// Create getPointFromEvent function
	const getPointFromEventFn = useCallback(
		(e: React.MouseEvent | MouseEvent) => getPointFromEvent(e, containerRef.current),
		[],
	);
	...
	const handleCanvasMouseDown = useCallback(
		...
		[getPointFromEventFn, handleCanvasMouseDownBase, isThinkingPen, addPathPoint],
	);

	const handleCanvasMouseMove = useCallback(
		(e: React.MouseEvent<HTMLCanvasElement>) => {
			const point = getPointFromEventFn(e);
			handleCanvasMouseMoveBase(point, isThinkingPen ? addPathPoint : undefined);
		},
		[getPointFromEventFn, handleCanvasMouseMoveBase, isThinkingPen, addPathPoint],
	);
	...
	const handleCanvasMouseMoveForBrush = useCallback(
		...
		[isDrawing, isEraser, isThinkingPen, selectedComponentType, getPointFromEventFn],
	);
	...
	const handleComponentMouseDown = useCallback(
		(e: React.MouseEvent, componentId: string) => {
			const point = getPointFromEventFn(e);
			handleComponentMouseDownBase(e, componentId, point, isEraser, setSelectedComponentIds);
		},
	...
	const handleContainerMouseMove = useCallback(
		...
		[getPointFromEventFn, updateSelectionBox, draggedComponentId, resizingComponentId, handleContainerMouseMoveBase],
	);
